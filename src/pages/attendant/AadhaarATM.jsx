...
function downloadCSV(rows) {
  ...
  link.href = url;
  link.download = `aadhaar-atm-${new Date()
    .toISOString()
    .slice(0, 10)}.csv`;
...
export default function AadhaarATM() {
  ...
  useEffect(() => {
    ...
    const unsubscribeAuth = onAuthStateChanged(auth, (currentUser) => {
      ...
      if (!currentUser) {
        setRecords([]);
        setLoading(false);
        setError("Please login to access Aadhaar ATM.");
        return;
      }
      ...
      unsubscribeSnapshot = onSnapshot(
        ...
        (err) => {
          console.error(err);
          setError("Unable to load Aadhaar ATM records.");
          setLoading(false);
        }
      );
    });
    ...
    try {
      ...
      setError(
        err?.code === "permission-denied"
          ...
          : "Failed to save Aadhaar ATM transaction."
      );
    } finally {
      setSaving(false);
    }
  ...
  const handleDelete = async (item) => {
    const confirmed = window.confirm(
      `Delete Aadhaar ATM transaction for ${item.customerName || "this customer"
      }?`
    );
    ...
    <div className="money-page">
      <div className="page-head money-page-head">
        <div>
          ...
          <p>
            Track Aadhaar ATM withdrawals and shop commissions.
          </p>
        </div>
        ...
        <div className="money-toolbar">
          <div className="money-search">
            ...
            <input
              ...
              placeholder="Search customer, phone, bank..."
            />
          </div>
        ...
        <div className="money-table-wrap">
          {loading ? (
            <div className="money-empty">
              ...
              <h3>Loading Aadhaar ATM...</h3>
            </div>
          ) : filteredRecords.length === 0 ? (
            <div className="money-empty">
              <div className="money-empty-icon orange">
                <Fingerprint size={24} />
              </div>

              <h3>No Aadhaar ATM transactions</h3>

              <p>
                Add your first withdrawal transaction to start
                tracking ATM activity.
              </p>
                  ...
                  <tr key={item.id}>
                    ...
                    <td>
                      <div className="customer-cell">
                        <div className="customer-avatar orange">
                          {(item.customerName || "C")
                            .charAt(0)
                            .toUpperCase()}
                        </div>
              ...
              <div className="form-grid">
                ...
                <label>
                  ...
                  <input
                    ...
                    placeholder="ATM transaction reference"
                  />
                </label>
              </div>
